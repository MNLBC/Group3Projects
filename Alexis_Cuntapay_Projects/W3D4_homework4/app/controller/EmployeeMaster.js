Ext.define('Company.controller.EmployeeMaster',
{
    ...
    onCreateClick: function () {
        ...
        employeeModel.set("firstName", "First name");
        employeeModel.set("middleName", "Middle name");
        employeeModel.set("lastName", "Last name");
        employeeModel.set("birthDate", "11/13/1995");
        employeeModel.set("city", "City");
        employeeModel.set("state", "State");

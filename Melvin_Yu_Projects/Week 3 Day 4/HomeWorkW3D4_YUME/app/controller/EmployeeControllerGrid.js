Ext.define('Office.controller.EmployeeControllerGrid', {
	extend : 'Ext.app.Controller',
	models : [ 'Office.model.Employee' ],
	stores : [ 'Office.store.Employee' ],
	views : [ 'Office.view.EmployeeGrid' ],
	refs : [ {
		ref : 'employeeGrid',
	...
	onCreateClick : function() {
		...
		var employeeModel = Ext.create('Office.model.Employee');
	...
	onLoadClick : function() {
		var employeeStore = Ext.getStore('Office.store.Employee');
		employeeStore.load();
	},

							...
							<div id="divBodyCartModal">
								...
								<div class="row">
									...
									<div class="col-xs-6">
										<div class="col-xs-6 text-right">
											<h6>
												<strong><label id="lblCartItemPrice1">25.00</label>
								...
								<div class="row">
									...
									<div class="col-xs-6">
										<div class="col-xs-6 text-right">
											<h6>
												<strong><label id="lblCartItemPrice2">50.00</label><span
								...
								<div class="row">
									...
									<div class="col-xs-6">
										<div class="col-xs-6 text-right">
											<h6>
												<strong><label id="lblCartItemPrice3">100.00</label><span
													class="text-muted">x</span></strong>
											</h6>
										</div>
										<div class="col-xs-4">
...
<script type="text/javascript">
	function updateCart() {
		...
		var totalCost = (cartItem1 * cartPrice1) + (cartItem2 * cartPrice2)
				+ (cartItem3 * cartPrice3);
	...
	function myFunction() {
		...
		document.getElementById('divBodyCartModal').innerHTML = Test
				+ '<div class="row">'

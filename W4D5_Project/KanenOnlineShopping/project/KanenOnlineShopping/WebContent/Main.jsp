			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="col-item">
					<div class="post-img-content">
						<img src="resources/macbook.jpg" class="img-responsive" /> <span
						...
						<div class="row">
							...
							<div class="rating hidden-sm col-md-6">
								<i class="price-text-color fa fa-star"></i><i
									...
									class="price-text-color fa fa-star"></i><i
									class="price-text-color fa fa-star"> </i><i class="fa fa-star"></i>
							</div>
						</div>
						<div class="separator clear-left">
							<p class="btn-add">
	...
	<div class="container" style="margin-top: 50px;">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="col-item">
					<div class="post-img-content">
						<img src="resources/phone.jpg" class="img-responsive" /> <span
							class="post-title"> </span>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="col-item">
					<div class="post-img-content">
						<img src="resources/acc.jpg" class="img-responsive" /> <span
							class="post-title"> </span>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="col-item">
					<div class="post-img-content">
						<img src="resources/acc3.jpg" class="img-responsive" alt="a" /> <span
							class="post-title"> </span>

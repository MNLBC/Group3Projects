Ext.define('Company.controller.EmployeeInfo', {
    extend: 'Ext.app.Controller',
    models: ['Company.model.Employee2'],
    views: ['Company.view.EmployeeInfo'],

    refs: [{
        ref: 'employeeMasterForm',
        selector: 'viewport > EmployeeInfo'
    }],

    init: function () {
        this.control({

            'viewport > EmployeeInfo button[itemId=btnCreate]': {
                click: this.onCreateClick
            },
            'viewport > EmployeeInfo button[itemId=btnLoad]': {
                click: this.onLoadClick
            },
            'viewport > EmployeeInfo button[itemId=btnUpdate]': {
                click: this.onUpdateClick
            },
            'viewport > EmployeeInfo button[itemId=btnDelete]': {
                click: this.onDeleteClick
            },
            'viewport > EmployeeInfo button[itemId=btnReset]': {
                click: this.onResetClick
            },
            'viewport > EmployeeInfo button[itemId=btnClear]': {

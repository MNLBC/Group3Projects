...
public class AbstractJPADAO<GenericEntity> implements GenericDAO<GenericEntity> {
	private EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("unitEclipseLink",
	...
	public AbstractJPADAO() {
		entityClass = (Class<GenericEntity>) ((java.lang.reflect.ParameterizedType) this.getClass()

...
public class UserMembershipAsn implements Serializable {
	...
	public UserMembershipAsn(long userMembershipId, long membershipTypeId, long requestMembershipTypeId,
			long forApproval, long requestApproved) {
		super();
	...
	/**
	 * @param requestMembershipTypeId
	 *            the requestMembershipTypeId to set
	 */
	 ...
	 */
	public long getForApproval() {
		return forApproval;
	}

	/**
	 * @param forApproval
	 *            the forApproval to set
	 */
	public void setForApproval(long forApproval) {
		this.forApproval = forApproval;
	}
	 ...
	 */
	public long getRequestApproved() {
		return requestApproved;
	}

	/**
	 * @param requestApproved
	 *            the requestApproved to set
	 */
	public void setRequestApproved(long requestApproved) {
		this.requestApproved = requestApproved;
	}

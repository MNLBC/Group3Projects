Ext.define('Employees.controller.EmployeeMaster2', {
    extend: 'Ext.app.Controller',
    models: ['Employees.model.Employee2'],
    ...
    onUpdateClick: function () {
        ...
        var employeeModel = Ext.create('Employees.model.Employee2');
            ...
            success: function (record, operation) {
                try {
                    ...
                    if (resp.success) {
                        ...
                        var employee = Ext.create('Employees.model.Employee2');
    ...
    onLoadClick: function () {
        ...
        var existingEmployee = Ext.ModelMgr.getModel('Employees.model.Employee2');
        var empMaster = this.getEmployeeMasterForm();

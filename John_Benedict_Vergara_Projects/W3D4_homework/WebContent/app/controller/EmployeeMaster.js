Ext.define('Employees.controller.EmployeeMaster',
{
    extend: 'Ext.app.Controller',
    models: ['Employees.model.Employee'],
    stores: ['Employees.store.Employee'],
    views: ['Employees.view.EmployeeGrid'],
    refs: [{
        ref: 'employeeGrid',
    ...
    onCreateClick: function () {
        ...
        var employeeModel = Ext.create('Employees.model.Employee');
    ...
    onLoadClick: function () {
        var employeeStore = Ext.getStore('Employees.store.Employee');
        employeeStore.load();
    },

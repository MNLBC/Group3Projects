...
INSERT INTO ORDER_INVOICE(INVOICE_ID,ORDER_ID,DATE_RAISED,AMOUNT_DUE,DATE_SETTLED,DATE_CANCELLED,LAST_UPDATED_TIME) 
	...
	--for oracle database
CREATE SEQUENCE CUSTOMER_SEQ START WITH 120 INCREMENT BY 10 NOCYCLE CACHE 20;
COMMIT;

CREATE SEQUENCE PRODUCT_SEQ START WITH 2050 INCREMENT BY 10 NOCYCLE CACHE 20;

CREATE SEQUENCE ORDER_SEQ START WITH 444 INCREMENT BY 111 NOCYCLE CACHE 20;

CREATE SEQUENCE ORDER_INVOICE_SEQ START WITH 4 INCREMENT BY 1 NOCYCLE CACHE 20;

...
public class MainApp {
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext("com/oocl/mnlbc/number2/Beans.xml");
		...
		try {
			userJDBCTemplate.create("kanench", "admin123", "Christian", "Kanen");
			userJDBCTemplate.create("zhaita", "admi", "admin", "admin");
		} catch (Exception e) {
			e.printStackTrace();
		}

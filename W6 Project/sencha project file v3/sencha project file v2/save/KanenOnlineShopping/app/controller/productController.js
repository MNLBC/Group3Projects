...
Ext.define('KanenOnlineShopping.controller.productController', {
                                                            ...
                                                            if(btn=='yes'){
                                                                ...
                                                                var userId = userStore.data.items[0].data.userId;
                                                                 ...
                                                                 Ext.Ajax.request({
                                                                     ...
                                                                     url: window.location.pathname +'cart/cartItem',
                                                                     method: 'POST',
    ...
    onBtnSendRequestClick: function() {
        ...
        var userStore= Ext.getStore('userStore');
        var userId = userStore.data.items[0].data.userId;
        var userOldMemberType= userStore.data.items[0].data.userMemberType;
        var combo = Ext.getCmp('memberShipField');
        var userMemberType = combo.value;
            if (userOldMemberType)
